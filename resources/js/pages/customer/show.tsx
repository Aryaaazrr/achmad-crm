...
export default function CustomerShow({ customer, project, leads, products, detailProducts }: Props) {
    ...
    return (
        <AppLayout>
            ...
            <div className="mx-6 flex h-20 items-center justify-between rounded-xl bg-muted/50 p-4">
                <div>
                    <h1 className="text-xl font-black">Detail Service Customer</h1>
                    <p className="text-sm text-muted-foreground">Customer ID: #{customer.id_customer}</p>
                </div>
