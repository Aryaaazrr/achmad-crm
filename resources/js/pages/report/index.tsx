...
export default function ReportingDashboard() {
    ...
    return (
        <AppLayout>
            ...
            <div className="mx-6 h-full rounded-xl bg-muted/50">
                {/* Filters */}
                <Card className='m-4'>
                    <CardHeader>
                ...
                {/* KPI Cards */}
                <div className="grid grid-cols-1 gap-4 mx-4 md:grid-cols-2 lg:grid-cols-4">
                    <Card>
                ...
                {/* Charts */}
                <div className="grid grid-cols-1 m-4 gap-6 lg:grid-cols-2">
                    <Card>
                        <CardHeader>
                ...
                {/* Data Tables */}
                <Tabs value={reportType} onValueChange={setReportType} className="m-4">
